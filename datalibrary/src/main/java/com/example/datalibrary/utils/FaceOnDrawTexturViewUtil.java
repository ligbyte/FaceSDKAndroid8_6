...
public class FaceOnDrawTexturViewUtil {
    ...
    public static void drawFace(Context context , Paint paint , RectF rectF , Canvas canvas , float lWidth , float sWidth , float fArea){
        float lineWidth = DensityUtils.px2dip(context, lWidth);
        float strokeWidth = DensityUtils.px2dip(context, sWidth);
        float faceArea = DensityUtils.px2dip(context, fArea);
        // 左上横线
        canvas.drawRect(
                rectF.left,
                rectF.top,
        ...
        // 左下竖线
        canvas.drawRect(rectF.left,
                rectF.bottom - lineWidth,
                rectF.left + strokeWidth,
                rectF.bottom,
                paint);
        // 右下横线
        canvas.drawRect(rectF.right - lineWidth,
                rectF.bottom,
                rectF.right,
                rectF.bottom + strokeWidth,
                paint);
        ...
        paint.setAlpha(25);
        canvas.drawRect(rectF.left + faceArea,
                rectF.top + faceArea,
                rectF.right - faceArea,
                rectF.bottom - faceArea,
                paint);
    }
